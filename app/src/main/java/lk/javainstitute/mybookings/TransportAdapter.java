...
public class TransportAdapter extends RecyclerView.Adapter<TransportAdapter.ViewHolder> {
    private List<Transport> placeList;

    public TransportAdapter(List<Transport> placeList) {
        this.placeList = placeList;
    }

    public void addEmptyItem() {
        placeList.add(0, new Transport("", ""));
        notifyItemInserted(0);
    }
    public List<Transport> getPlaceList() {
        return placeList;
    }
    ...
    public void onBindViewHolder(@NonNull TransportAdapter.ViewHolder holder, int position) {
        Transport place = placeList.get(position);
